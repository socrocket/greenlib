...
#ifndef __GREEN_TARGET_SOCKET_H__
#define __GREEN_TARGET_SOCKET_H__
...
template <unsigned int BUSWIDTH=32,
          ...
          >
class target_socket: 
                             public target_socket_base<BUSWIDTH,TRAITS,1,BIND_BASE>
{
public:
  //the constructor requires a name
  target_socket(const char* name) : target_socket_base<BUSWIDTH,TRAITS,1,BIND_BASE>(name){}
};
