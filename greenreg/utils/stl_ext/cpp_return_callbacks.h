...
#ifndef __CPP_RETURN_CALLBACKS_H__
#define __CPP_RETURN_CALLBACKS_H__
...
////////////////////////////////////////////
/// cpp_callback
/// implementation for 0 param standard cpp
/// callback.
/// @author 
/// @since 
////////////////////////////////////////////
template< class C, typename R>
class cpp_callback_0 :
public callback_0< R>
{
public:
	define_callback( cpp_callback_t, C, R);
  
	cpp_callback_0() : m_callback_class_instance(0) {
    callback_0<R>::is_void = false;
    callback_0<R>::number_params = 0;
  }
  ...
  /// @see cpp_callback
  ////////////////////////////////////////////
	inline virtual R execute()
	{
		assert( m_callback_class_instance != 0);
		return( (m_callback_class_instance->*m_callback)());
	}
...
class cpp_callback_1 :
public callback_1< R, P1>
{
public:
	define_callback_1( cpp_callback_t, C, R, P1);
  
	cpp_callback_1() : m_callback_class_instance(0) {
    callback_1<R, P1>::is_void = false;
    callback_1<R, P1>::number_params = 1;
  }
  ...
  /// @see cpp_callback_1
  ////////////////////////////////////////////
	inline virtual R execute(P1 & _p1)
	{
		assert( m_callback_class_instance != 0);
...
class cpp_callback_2 :
public callback_2< R, P1, P2>
{
public:
  define_callback_2( cpp_callback_t, C, R, P1, P2);
  
	cpp_callback_2() : m_callback_class_instance(0) {
    callback_2< R, P1, P2>::is_void = false;
    callback_2< R, P1, P2>::number_params = 2;
  }
  ...
  /// @see cpp_callback_2
  ////////////////////////////////////////////
	inline virtual R execute( P1 & _p1, P2 & _p2)
	{
		assert( m_callback_class_instance != 0);
...
class cpp_callback_3 :
public callback_3< R, P1, P2, P3>
{
public:
	define_callback_3( cpp_callback_t, C, R, P1, P2, P3);
  
	cpp_callback_3() : m_callback_class_instance(0) {
    callback_3< R, P1, P2, P3>::is_void = false;
    callback_3< R, P1, P2, P3>::number_params = 3;
  }
  ...
  /// @see cpp_callback_3
  ////////////////////////////////////////////
	inline virtual R execute( P1 & _p1, P2 & _p2, P3 & _p3)
	{
		assert( m_callback_class_instance != 0);
...
#endif //__CPP_RETURN_CALLBACKS_H__
