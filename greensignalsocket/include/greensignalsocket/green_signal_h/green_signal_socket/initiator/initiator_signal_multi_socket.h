#ifndef INITIATOR_SIGNAL_MULTI_SOCKET_H_
#define INITIATOR_SIGNAL_MULTI_SOCKET_H_
...
/*!
* @brief: The initiator_signal_multi_socket basically derived from the initiator_signal_multi_base_socket
* with gs_generic_signal_protocol_types as traits.
* 
*/
class initiator_signal_multi_socket:
	public virtual initiator_signal_multi_base_socket
{
public:
	typedef initiator_signal_socket_wrapper<initiator_signal_multi_base_socket> wrapper_types;
	initiator_signal_multi_socket(const char* name, gs::socket::allocation_scheme alloc_scheme=gs::socket::GS_TXN_ONLY):
	initiator_signal_multi_base_socket( name, alloc_scheme)
	{
			wrapper= new wrapper_types((initiator_signal_multi_base_socket*)this);
	}
	
	
	wrapper_types * operator->(){return wrapper;}
	~initiator_signal_multi_socket(){delete  wrapper;}
private:
	wrapper_types * wrapper;
};

}
#endif /*INITIATOR_SIGNAL_MULTI_SOCKET_H_*/
