...
public:
  ...
  , ulong_param("ulong_param")
  , ulonglong_param("ulonglong_param")
  
  , time_param1("time_param1", sc_core::sc_time(500, sc_core::SC_NS))
  , time_param2("time_param2")
  , time_param3("time_param3")
  { 
    // Demonstration of documentation feature
    int_param.set_documentation("Documentation of this parameter: Never set it to a value larger than 10. Simulation will explode.");
  ...
  gs::gs_param<short>           short_param;
  gs::gs_param<unsigned short>  ushort_param;
  ...
  gs::gs_param<unsigned long>      ulong_param;
  gs::gs_param<unsigned long long> ulonglong_param;
