...
int sc_main(int argc, char *argv[]) {
  ...
  // GreenAV Plugin
  gs::av::GAV_Plugin analysisPlugin(gs::av::STDOUT_OUT); // Leave out the plugin completely to show that the simulation does not crash (but does not analyze of course)
  // negative test:
